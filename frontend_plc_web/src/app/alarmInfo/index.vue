...
<script>
  ...
  import alarmInfoCreate from './components/alarm_info_create.vue'
  import alarmInfoEdit from './components/alarm_info_edit.vue'
  import alarmInfoDelete from './components/alarm_info_delete.vue'
