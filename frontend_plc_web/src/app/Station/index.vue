...
<script>
  ...
  import stationCreate from './components/station_create.vue'
  import stationEdit from './components/station_edit.vue'
  import stationDelete from './components/station_delete.vue'
